            ...
            ScrollView {
                VStack(spacing: 0) {
                    ...
                    ZStack(alignment: .center) {
                        ...
                        HStack(spacing: 0) {
                            // Line 1 - Gradient from black to gray
                            Rectangle()
                                .fill(
                                    LinearGradient(
                    ...
                    VStack(alignment: .leading, spacing: 6) {
                        ...
                        HStack(spacing: 4) {
                            ...
                            Button(action: {
                                if let url = URL(string: "https://www.assemblyai.com/dashboard/api-keys") {
                        ...
                        // API Key input field - masked with 8 asterisks
                        SecureField("Paste your AssemblyAI API key here", text: $apiKeyInput)
